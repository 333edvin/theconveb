      ...
      <div className="max-w-4xl mx-auto w-full">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3 md:gap-6 mb-6 md:mb-12 w-full">
          ...
          <div className="relative group w-full sm:w-auto">
            ...
            <Link href='/contact'>
            <button className="relative  sm:w-auto bg-white text-black px-8 md:px-10 py-3 md:py-4 text-sm md:text-lg font-medium hover:bg-gray-100 transition-colors duration-300">
              Start a Project
            </button>
            </Link>
          </div>
