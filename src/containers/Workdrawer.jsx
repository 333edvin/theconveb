    ...
    return (
        ...
        >
            ...
            >
                ...
                >
                    {/* main cover image */}
                    <div className="w-full rounded-xl sm:rounded-2xl overflow-hidden mb-5 bg-white/5">
                        <Image
                            width={1600}
                            height={1200}
                            src={work.cover}
                    ...
                    {work.images && work.images.length > 0 && (
                        ...
                        >
                            {work.images.map((src, i) => (
                                <div
                                    key={i}
                                    className="flex-shrink-0 rounded-lg sm:rounded-xl overflow-hidden bg-white/5 max-w-96 w-32 md:w-72 h-52 md:h-96"
